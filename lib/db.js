...
ALTER TABLE projects ADD COLUMN IF NOT EXISTS source_hash text;
CREATE UNIQUE INDEX IF NOT EXISTS projects_source_path_idx ON projects (source_path) WHERE source_path IS NOT NULL;
