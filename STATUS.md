...
- On 2026-08-25, the Past grid thumbnail migration was repaired. The original importer incorrectly zipped Wix gallery images and project links by DOM order even though Wix positioned them independently, shifting images onto unrelated projects. The 25 linked source-grid images are now mapped by their verified visual tile positions; the nine linked projects without a source-grid image use their own first detail-page image. Thirty production thumbnails were updated with before/after CMS history, all 34 images load, and the repair is idempotent and regression-tested.
- Four non-main visual-review branches now share the clear colleague-requested presentation changes: muted palette tokens, the founding artists in the About origin sentence, “IN MAIN GALLERY,” images before copy on Future, a prominent Visit address/hours panel with the elevator-step note, and tighter Donate spacing. Email ownership, the Venmo recipient, and calendar removal remain unchanged pending explicit decisions.
